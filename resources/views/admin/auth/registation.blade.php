                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        ...
                        <div class="card mb-5 border-0 shadow-lg rounded-2">
                            <div class="card-body px-4">
                                <h4 class="text-uppercase fw-semibold mb-3 text-center border-bottom pb-4 pt-2">Admin register</h4>
                                ...
                                <form method="POST" action="{{ route('admin.register') }}">
                                    ...
                                    <div class="text-center mt-3">
                                        <p>Already have an account?
                                            <a href="{{ route('admin.login') }}" class="text-decoration-none">Login now</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
