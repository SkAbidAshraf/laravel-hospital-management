            ...
            <form method="POST" action="{{ route('dashboard.doctor.submit') }}" id="common_alert"
                ...
                <div class="row">
                    <div class="my-2 col-md-6">
                        ...
                        <input type="text" class="form-control @error('doctor_name') is-invalid @enderror"
                            name="doctor_name" value="{{ old('doctor_name') }}" placeholder="Doctor name" id="doctor_name">
                        @error('doctor_name')
                ...
                <div class="my-2">
                    ...
                    <textarea class="form-control @error('doctor_details') is-invalid @enderror" id="ck_editor" rows="10"
                        name="doctor_details">{{ old('doctor_details') }}</textarea>
